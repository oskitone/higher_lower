...
- Confirm it powers up and operates with just the cable (and its power switch off!).
- Are you using one of the [known good](#required-equipment) programmers? Confirm it's plugged in with green/black sides correctly.
